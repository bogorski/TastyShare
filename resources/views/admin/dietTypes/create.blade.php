...
<div class="container my-5 d-flex justify-content-center">
    <form action="{{ route('admin.dietTypes.store') }}" method="POST" enctype="multipart/form-data" class="shadow-sm p-4 bg-white rounded custom-form">
        @csrf
        ...
        <a href="{{ route('admin.dietTypes.index') }}" class="btn btn-secondary ms-2">Anuluj</a>
    </form>
</div>
@endsection
@endadmin